...
class AboutClassMethods < Neo::Koan
  ...
  # I prefer self.method since it is simple and descriptive. makes it clear that it is a class method
  # Are there times you might prefer one over the other?
  # 2nd way improves code readability and easier to refactor when not having to repeatedly type self.
