...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # With inject, its argument is the initialization of whatever is the first 
    # parameter of the block and it then iterates the array and evaluates the block. 
    # So, if we change the argument from 0 to 5 in the first test, sum is initialized
    # to 5, we then iterate through the array and sum up the values, and the result of
    # 14 is stored into the var result.
  end
